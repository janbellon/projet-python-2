...
o auteur,
o catégorie,
o disponibilité (emprunté ou non).
...
o le nombre d’exemplaires disponibles diminue ;
o l’application enregistre la date d’emprunt.
• Lorsqu’un livre est rendu :
o le nombre d’exemplaires disponibles augmente ;
o l’application met à jour le statut du livre.
...
o liste des livres,
o dictionnaire des utilisateurs,
o set pour les livres empruntés par un lecteur, etc.
